...
- `chapter1_intro.md`: 已按工程型论文要求收敛为 1.1 至 1.4，包含项目背景与意义、核心概念定义、国内外同类方案分析、本文主要工作和组织结构；第 1 章不再设置本章小结。
- `chapter2_related_work.md`: 已调整为相关理论及技术综述，补齐推荐系统、基于内容推荐、TF-IDF、协同过滤、可解释推荐、LLM 辅助解释、混合推荐和技术路线选择。
- `chapter3_analysis.md`: 已按主要功能重写为需求分析章节，重点描述用户与标签维护、画像构建与推荐生成、推荐解释、用户反馈与画像更新四类需求；数据需求已删除。
