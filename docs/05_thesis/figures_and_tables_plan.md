...
- 第 4 章分别表达系统整体架构、功能模块、核心流程和数据存储模型。
- 第 5 章按重点模块给出业务流程图、类图、时序图和主要界面图。
...
| 图 4-4 | 数据存储 ER 图 | 第 4 章 | 展示用户、标签、画像、推荐结果、推荐解释和用户反馈的实体关系与关键属性 | `docs/generated/figures/ch4-4-conceptual-model.png` |
...
| 表 4-1 | 用户基础信息表设计 | 第 4 章 | 说明 user 表字段 | `chapter4_design.md` |
| 表 4-2 | 标签定义表设计 | 第 4 章 | 说明 tag 表字段 | `chapter4_design.md` |
| 表 4-3 | 用户标签关系表设计 | 第 4 章 | 说明 user_tag_relation 表字段 | `chapter4_design.md` |
| 表 4-4 | 用户画像表设计 | 第 4 章 | 说明 user_profile 表字段 | `chapter4_design.md` |
| 表 4-5 | 推荐结果表设计 | 第 4 章 | 说明 recommendation_result 表字段 | `chapter4_design.md` |
| 表 4-6 | 推荐解释表设计 | 第 4 章 | 说明 recommendation_explanation 表字段 | `chapter4_design.md` |
| 表 4-7 | 用户反馈表设计 | 第 4 章 | 说明 user_feedback 表字段 | `chapter4_design.md` |
...
| 表 5-2 | 推荐算法候选方案说明 | 第 5 章 | 说明五类候选推荐算法的排序依据、设计目的和取舍说明 | `chapter5_implementation.md` |
| 表 5-3 | 推荐解释与反馈关键数据说明 | 第 5 章 | 说明标签贡献、规则命中、可信连接原因、反馈类型和画像版本用途 | `chapter5_implementation.md` |
| 表 6-1 | 测试环境说明 | 第 6 章 | 说明 JDK、构建工具、数据库、缓存组件、测试数据和结果核验方式 | `chapter6_test.md` |
| 表 6-2 | 用户与标签维护测试用例 | 第 6 章 | 说明用户与标签维护功能测试 | `chapter6_test.md` |
| 表 6-3 | 画像构建与推荐生成测试用例 | 第 6 章 | 说明画像构建与推荐生成功能测试 | `chapter6_test.md` |
| 表 6-4 | 推荐解释测试用例 | 第 6 章 | 说明推荐解释功能测试 | `chapter6_test.md` |
| 表 6-5 | 用户反馈与画像更新测试用例 | 第 6 章 | 说明反馈闭环功能测试 | `chapter6_test.md` |
| 表 6-6 | 透明链路与评估展示测试用例 | 第 6 章 | 说明透明链路与评估展示功能测试 | `chapter6_test.md` |
| 表 6-7 | 响应可用性测试用例 | 第 6 章 | 说明非功能性响应可用性测试 | `chapter6_test.md` |
| 表 6-8 | 可解释性测试用例 | 第 6 章 | 说明推荐解释可追溯性测试 | `chapter6_test.md` |
| 表 6-9 | 可维护性与可验证性测试用例 | 第 6 章 | 说明模块边界与材料复核测试 | `chapter6_test.md` |
...
| 表 6-13 | 场景参数实验结果 | 第 6 章 | 说明不同场景和 TopK 下 Precision@K 和 NDCG@K 变化 | `chapter6_test.md` |
| 表 6-14 | 扩展评估结果节选 | 第 6 章 | 说明固定种子扩展数据集下 A4 与 A5 的规模评估结果 | `chapter6_test.md` |
