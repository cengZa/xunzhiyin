...
## 当前状态
- 已新增 `application-local.yml`，支持通过环境变量覆盖 MySQL / Redis 连接信息
- 已补可执行的 [schema.sql](D:\.projects\xunzhiyin\xunzhiyin\docs\03_backend\schema.sql) 与运行时 [schema-local.sql](D:\.projects\xunzhiyin\xunzhiyin\src\main\resources\schema-local.sql)
- 已新增 [run-local-env-verification.ps1](D:\.projects\xunzhiyin\xunzhiyin\scripts\run-local-env-verification.ps1)
...
- `docs/exec-plans/active/2026-04-03_integration_verification.md`
